...
BEGIN_MESSAGE_MAP(CMFCApplication3Dlg, CDialogEx)
	...
	ON_LBN_SELCHANGE(IDC_LIST_CHAT, &CMFCApplication3Dlg::OnLbnSelchangeListChat)
	ON_BN_CLICKED(IDC_BUTTON_SEND, &CMFCApplication3Dlg::OnBnClickedButtonSend)
END_MESSAGE_MAP()
...
void CMFCApplication3Dlg::OnLbnSelchangeListChat()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}


void CMFCApplication3Dlg::OnBnClickedButtonSend()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CString msg;
