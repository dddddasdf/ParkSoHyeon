...
{
	int iReturnConstant;
	int iTempType = 0, iTempIndex = 0;

	iReturnConstant = PrintWeaponList(HaveGold, TYPE_DAGGER, m_iDaggerCount, &iTempType, &iTempIndex, DaggerStruct);

	*WeaponType = iTempType;
	*WeaponIndex = iTempIndex;
