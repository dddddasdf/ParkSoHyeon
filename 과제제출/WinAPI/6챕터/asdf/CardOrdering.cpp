...
int CardOrdering::CheckOverlap(int MouseX, int MouseY)
{
...
bool CardOrdering::IsCorrect(int IndexFirst, int IndexSecond)
{
...
void CardOrdering::CardReset(int IndexFirst, int IndexSecond)
{
