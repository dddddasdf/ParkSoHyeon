...
//struct WeaponNode
//{
//	WeaponStruct WeaponInformation;
//	WeaponNode *Next;
//};

struct WeaponStack
{
	WeaponStruct *WeaponArray;
	int iTopIndex;
};
...
public:
	...
	void PushWeaponStack(WeaponStack *Array, WeaponStruct *TypeWeapon, int WeaponType, int WeaponNumber, int *YPos);
	void PopWeaponStack(WeaponStack *Array, int *YPos);
